...
public class Position extends Message {
    ...
    public static final String KEY_CALIBRATED_FUEL_LEVEL = "calib_fuel"; // liters
    ...
    public static final String KEY_FUEL_IS_OUTLIER = "fuelIsOutlier"; // Bookkeeping flag for outliers.
