...
public class Event extends Message {
    ...
    public static final String TYPE_DEVICE_IDLING = "deviceIdling";
    public static final String TYPE_DEVICE_STANDSTILL = "deviceStandstill";
    ...
    public static final String TYPE_DRAIN_WITHIN_CONSUMPTION = "drainWithinConsumption";
    public static final String TYPE_DRAIN_DUE_TO_NOISE = "drainDueToNoise";
    public static final String TYPE_FILL_DUE_TO_NOISE = "fillDueToNoise";
